...
# Adapted from: https://github.com/actumn/touhou10-dqn/blob/master/th10/memory_reader.py
...
class DataReader:
    ...
    def player_info(self):
        ...
        if base_addr == 0:
            return Player((0, 400), (0,0), 0, 0)

        p = (self.read_float(base_addr + 0x3C0), self.read_float(base_addr + 0x3C4))
        v = (self.read_float(base_addr + 0x3F0) / 100., self.read_float(base_addr + 0x3F4) / 100.)
